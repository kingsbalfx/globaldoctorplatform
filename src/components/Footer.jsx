  ...
  const socialLinks = [
    {
      ...
      url: import.meta.env.VITE_SOCIAL_TWITTER || 'https://x.com/globaldocconnect',
    ...
    },
    {
      ...
      url: import.meta.env.VITE_SOCIAL_FACEBOOK || 'https://facebook.com/globaldocconnect',
    ...
    },
    {
      ...
      url: import.meta.env.VITE_SOCIAL_INSTAGRAM || 'https://instagram.com/globaldocconnect',
    ...
    },
    {
      ...
      url: import.meta.env.VITE_SOCIAL_TELEGRAM || 'https://t.me/globaldocconnect',
    ...
    },
    {
      ...
      url: import.meta.env.VITE_SOCIAL_SNAPCHAT || 'https://snapchat.com/add/globaldocconnect',
    ...
    },
    {
      ...
      url: import.meta.env.VITE_SOCIAL_TIKTOK || 'https://tiktok.com/@globaldocconnect',
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="mailto:globaldoctorconnect@gmail.com" className="text-slate-300 hover:text-brand-400 transition-colors duration-200">
                  Support Email
                </a>
              </li>
            </ul>
            ...
            <div>
              ...
              <div className="space-y-2 text-slate-300">
                <p>
                  ...
                  <a href="mailto:globaldoctorconnect@gmail.com" className="text-brand-400 hover:text-brand-300">
        ...
        <div className="border-t border-slate-700 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex flex-wrap gap-6 text-sm">
              ...
              <a href="mailto:globaldoctorconnect@gmail.com" className="text-slate-400 hover:text-brand-400 transition-colors duration-200">
                Support
              </a>
            </div>
          </div>
