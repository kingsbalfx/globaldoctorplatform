...
import { p as Stethoscope, U as UserRound } from "./icons-Ci-JEzBE.js";
function getProfileGender(person = {}) {
...
function getProfilePhoto(person = {}) {
  return person.profilePhotoUrl || person.profile_photo_url || person.avatarUrl || person.avatar_url || person.photoUrl || person.photo_url || person.passportDataUrl || person.passport_data_url || "";
}
...
function GenderIcon({ gender, className }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(UserRound, { className, "aria-hidden": "true" });
}
...
function ProfileAvatar({ person = {}, role = "patient", size = "md", showLabel = false, className = "" }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `flex items-center gap-3 ${className}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `relative shrink-0 ${classes.wrap}`, children: [
      ...
      ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `flex h-full w-full items-center justify-center rounded-2xl bg-gradient-to-br ${palette} ring-2`, children: role === "doctor" && gender === "unspecified" ? /* @__PURE__ */ jsxRuntimeExports.jsx(Stethoscope, { className: classes.icon, "aria-hidden": "true" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(GenderIcon, { gender, className: classes.icon }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `absolute -bottom-1 -right-1 flex ${classes.badge} items-center justify-center rounded-full bg-white shadow ring-1 ring-slate-200`, children: gender === "unspecified" ? /* @__PURE__ */ jsxRuntimeExports.jsx(GenderIcon, { gender, className: "h-3 w-3 text-slate-700" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-black leading-none text-slate-700", children: GenderMark({ gender }) }) })
    ] }),
    showLabel && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "rounded-full bg-white/80 px-2.5 py-1 text-xs font-semibold text-slate-700 ring-1 ring-slate-200", children: label })
  ] });
}
export {
  ProfileAvatar as P,
