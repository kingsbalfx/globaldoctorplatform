...
const getSpecialtyInfo = (specialty) => {
  const normalized = String(specialty || "general").toLowerCase().replace(/&/g, "").replace(/[^a-z]/g, "");
...
const getSpecialtyLogo = (specialty) => getSpecialtyInfo(specialty).logo;
export {
  getSpecialtyLogo as a,
  getSpecialtyInfo as g
};
